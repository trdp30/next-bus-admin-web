    ...
    <div className="h-full flex items-center justify-center bg-gradient-to-br from-primary-600 to-secondary-600 p-5">
      <div className="bg-white rounded-xl shadow-2xl p-10 w-full max-w-md text-center">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Fleet Management System</p>
        </div>

        <div className="space-y-5">
          <button
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-200 rounded-lg px-6 py-3 text-gray-700 font-medium hover:border-primary-400 hover:shadow-lg transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed min-h-[48px]"
